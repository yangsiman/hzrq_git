            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    <div class="layui-input-inline" style="margin-top: 2px;margin-left: 10px;!important;">
                        <input type="text" class="layui-input" id="test1" value="<fmt:formatDate value="${myd.createTime}" pattern="yyyy-MM-dd"/>" placeholder="yyyy-MM-dd">
                    </div>
                </div>
            </div>
        </div>
...
<div class="wrapper1" style="">
    ...
    <div class="wrapper-chart" style="width: 100%;box-shadow: 0 -5px 10px #88888833;margin-top: 20px;padding-top: 10px;">
        <div class="chart-top">
...
<script>
    ...
    var option2 = {
        ...
        series: [
            {name: '当月累计得分和集团排名', type: 'line', data: [10, 30,50, 70]},
            {name: '年度累计得分和集团排名', type: 'line', data: [20, 40,60, 80]},
    ...
    layui.use('laydate', function(){
        ...
        laydate.render({
            elem: '#test1',
                ...
                console.log(value);
                window.location.href = "${path}/Main/popu?createTime="+value;
            }
        });
    });
</script>
