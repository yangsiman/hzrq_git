...
<body>
    <form method="post" action="${path}/SysRole/SaveAddRole" id="form1">
        <div class="rq_page_navigation_inpage">
            <a href="${path}/Main/UserMainPage">主页</a> / 系统配置 / <a href="${path}/SysRole/ManageList">角色权限配置</a> / 新增系统角色
        </div>
        <div class="rq_from">
                ...
                <div class="rq_form_box">
                    <div class="rq_form_item_box">
                        ...
                        <div class="rq_form_col_r">
                            <input name="roleName" type="text" id="roleName" class="pub_input1" />
                    ...
                    <div class="rq_form_item_box">
                        ...
                        <div class="rq_form_col_r">
                            <input name="roleCode" type="number" value="${maxSort}" id="roleCode" class="pub_input1" />
                    ...
                    <div class="rq_form_item_box">
                        ...
                        <div class="rq_form_col_r">
                            <input name="sort" type="number" value="${maxSort}" id="sort" class="pub_input1" />
                            <span class="rq_color_red">*</span><span class="rq_color_grey">只能输入数字且为整数</span>
                        </div>
                    </div>
                    ...
                    <div class="rq_form_item_box">
                        ...
                        <div class="rq_form_col_r">
                            <input name="description" type="text" id="description" class="pub_input1" style="width:50%;" />
