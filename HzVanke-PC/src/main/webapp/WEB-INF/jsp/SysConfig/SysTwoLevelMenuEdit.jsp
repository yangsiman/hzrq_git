...
<body>
<form id="form1" action="/SysTwoLevelMenu/SaveEditMenu" method="post">
    <div class="rq_page_navigation_inpage">
        <a href="${path}/Main/UserMainPage">主页</a> / 系统配置 / <a href="${path}/SysOneLevelMenu/ManageList">系统菜单管理</a> / 编辑二级菜单
    </div>
    <div class="rq_from">
        <div class="rq_from_back">
            <!-- 功能实现区/start -->
            <div class="rq_form_box">
                <input type="hidden" name="id" value="${sysTwolevelmenu.id}" />


                <div class="rq_form_item_box">
                    <div class="rq_form_col_1">所属一级菜单</div>
                    <div class="rq_form_col_r">
                        <select name="oneLevelMenuid" id="ddlPermissionsType">
                            <option value=""></option>
                            <c:forEach items="${listSysOneLevelmenu}" var="temp" varStatus="index">
                                <option value="${temp.id}" <c:if test="${temp.id==sysTwolevelmenu.oneLevelMenuid}">selected="selected"</c:if>>
                                    ${temp.managename}
                                </option>
                            </c:forEach>
                        </select>
                ...
                <div class="rq_form_item_box">
                    ...
                    <div class="rq_form_col_r">
                        <input value="${sysTwolevelmenu.menuName}" name="menuName" type="text" id="txtName" class="pub_input1" />
                        <span class="rq_color_red">*</span>
                    </div>
                </div>
                ...
                <div class="rq_form_item_box">
                    ...
                    <div class="rq_form_col_r">
                        <input value="${sysTwolevelmenu.menuCode}" name="menuCode" type="text" maxlength="6" id="txtCode" class="pub_input1" />
                ...
                <div class="rq_form_item_box">
                    ...
                    <div class="rq_form_col_r">
                        <input value="${sysTwolevelmenu.sort}" name="sort" type="number" id="txtSort" class="pub_input1" />
                ...
                <div class="rq_form_item_box">
                    ...
                    <div class="rq_form_col_r">
                        <input value="${sysTwolevelmenu.target}" name="target" type="text" id="txtTarget" class="pub_input1" />
                ...
                <div class="rq_form_item_box">
                    ...
                    <div class="rq_form_col_r">
                        <input value="${sysTwolevelmenu.className}" name="className" type="text" id="txtClassName" class="pub_input1" style="width:90%;" />
                        <span class="rq_color_red">*</span>
                    </div>
                </div>
                ...
                <div class="rq_form_item_box">
                    ...
                    <div class="rq_form_col_r">
                        <input value="${sysTwolevelmenu.pageUrl}" name="pageUrl" type="text" id="txtPageUrl" class="pub_input1" style="width:90%;" />
                        <span class="rq_color_red">*</span>
                    </div>
                </div>
            </div>
